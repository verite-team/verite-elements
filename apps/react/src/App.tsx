...
function App() {
  ...
  return (
    <div className="container">
      ...
      <RocClock onTimeChange={(e: CustomEvent) => console.log(e.detail)}></RocClock>
      ...
      <VfCard class="vf-card--signin" style={{ width: '360px' }}>
        <VfCardHeader>
          <div
            style={{
              display: 'flex',
          ...
          <VfCardTitle align="center">Sign in to Acme Co</VfCardTitle>
          <VfCardDescription align="center">Welcome back! Please sign in to continue</VfCardDescription>
        </VfCardHeader>
        <VfSignin onSubmit={() => console.log('Signin clicked')}>
          <div slot="providers">
            <VfFlex direction="column" gap={2} style={{ width: '100%' }}>
              <VfButton className="google-button" variant="outline" style={{ width: '100%' }}>
                <VfFlex valign="center" gap={2}>
                  <VfLogo name="apple" size={20}></VfLogo>
                  <VfLabel>Sign in with Apple</VfLabel>
                </VfFlex>
              </VfButton>

              <VfButton class="google-button" variant="outline" style={{ width: '100%' }}>
                <VfFlex valign="center" gap={2}>
                  <VfLogo name="google" size={20}></VfLogo>
                  <VfLabel>Sign in with Google</VfLabel>
                </VfFlex>
              </VfButton>
            </VfFlex>
            <VfDivider orientation="horizontal" style={{ margin: '16px 0' }}>
              <span>or</span>
            </VfDivider>
          </div>
        </VfSignin>
      ...
      <VfCard class="vf-card--signin" style={{ width: '360px' }}>
        <VfCardHeader>
          ...
          <VfCardTitle align="center">Sign up to Acme Co</VfCardTitle>
          <VfCardDescription align="center">Welcome! Please fill in the details to get started.</VfCardDescription>
        </VfCardHeader>
        <VfSignup onSubmit={() => console.log('Signin clicked')}>
          <div slot="providers">
            <VfFlex direction="column" gap={2} style={{ width: '100%' }}>
              <VfButton className="google-button" variant="outline" style={{ width: '100%' }}>
                <VfFlex valign="center" gap={2}>
      ...
      <div id="otp-container" style={{ width: '100%', maxWidth: '360px' }}>
        <VfCard class="vf-card--otp">
          <VfCardHeader>
            ...
            <VfCardTitle align="center">Please check your email</VfCardTitle>
            <VfCardDescription align="center">
              We've sent you a code to <span className="email-address">roboncode@gmail.com</span>
            </VfCardDescription>
          </VfCardHeader>
          <VfCardContent>
            <VeriteOtp />
        ...
        <div className="mt-4">
          <VfPoweredBy label="Secured by Verite"></VfPoweredBy>
        </div>
      </div>
    </div>
  )
