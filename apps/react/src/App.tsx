          ...
          <div slot="providers">
            <VuiFlex direction="column" gap={2} style={{ width: '100%' }}>
              <VuiButton className="google-button" variant="outline" style={{ width: '100%' }}>
                <VuiFlex valign="center" gap={2}>
                  <VuiLogo name="apple" size={20}></VuiLogo>
                  <VuiLabel>Sign in with Apple</VuiLabel>
                </VuiFlex>
              </VuiButton>

              <VuiButton class="google-button" variant="outline" style={{ width: '100%' }}>
                <VuiFlex valign="center" gap={2}>
                  <VuiLogo name="google" size={20}></VuiLogo>
                  <VuiLabel>Sign in with Google</VuiLabel>
                </VuiFlex>
              </VuiButton>
            </VuiFlex>
      ...
      <div id="otp-container" style={{ width: '100%', maxWidth: '360px' }}>
        <VuiCard class="card--otp" elevation="3">
          {/* <VuiCardHeader>
            ...
            <VuiCardTitle halign="center">Please check your email</VuiCardTitle>
            <VuiCardDescription halign="center">
        ...
        {/* <div className="fixed left-0 right-0 flex justify-center bottom-4">
          <VuiPoweredBy label="Secured by Verite"></VuiPoweredBy>
        </div> */}
      </div>
    </div>
  )
